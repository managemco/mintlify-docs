...
<Note>
  **For developers.** This page describes the OAuth flow used by third-party
  applications to act on behalf of a Managem user. If you're a seller, you
  don't need to read this — just sign in on
  [managem.co.uk](https://managem.co.uk) directly.
</Note>
