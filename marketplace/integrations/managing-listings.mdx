...
<Note>
  **For developers.** This guide is aimed at engineers building integrations
  that keep a third-party system in sync with Managem. If you're a seller
  looking to list or edit your own cards, use the
  [seller listings guide](/sellers/create-a-listing) and
  [imports](/sellers/imports) pages instead.
</Note>
...
2. Decide how you will map Managem data in your system:
