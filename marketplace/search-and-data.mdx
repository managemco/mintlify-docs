...
<Note>
  **For developers.** This section documents the public HTTP APIs Managem
  offers to third-party applications. If you're a seller looking to list and
  manage your cards on Managem, head to the
  [Sellers guide](/sellers/index) instead.
</Note>
...
<Card title="Items" href="/marketplace/data/items">
...
<Card title="Retrieval/Lookup" href="/api-reference/search/lookup-item">
