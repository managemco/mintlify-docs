...
<Note>
  **For developers.** This section is aimed at engineers building applications
  that integrate with Managem. If you're a seller looking to list cards or
  manage orders, head to the [Sellers guide](/sellers/index) instead.
</Note>
